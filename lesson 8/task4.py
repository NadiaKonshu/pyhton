...
class StoreMashines:
    ...
    def __init__(self, name, price, quantity, number_of_lists, *args):
        ...
        self.my_store_full = []
        self.my_store = []
        self.my_unit = {'Тип оргтехники': self.name, 'Цена за ед /руб': self.price, 'Количество/шт': self.quantity}
    ...
    def reception(self):
        ...
        try:
            ...
            unit_p = int(input(f'Введите цену за ед/руб '))
            unit_q = int(input(f'Введите количество/шт '))
            unique = {'Тип оргтехники': unit, 'Цена за ед/руб': unit_p, 'Количество/шт': unit_q}
